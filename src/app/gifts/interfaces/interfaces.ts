// To parse this data:
//
//   import { Convert, IGiftResponse } from "./file";
//
//   const IGiftResponse = Convert.toGiftResponse(json);
//
...
export class Convert {
    public static toGiftResponse(json: string): IGiftResponse {
        return cast(JSON.parse(json), r("IGiftResponse"));
    }

    public static giftResponseToJson(value: IGiftResponse): string {
        return JSON.stringify(uncast(value, r("IGiftResponse")), null, 2);
    }
}
